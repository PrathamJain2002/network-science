...
const API_BASE_URL = process.env.API_BASE_URL || 'http://localhost:8000'; // FastAPI backend URL
...
// Serve the translation editor
app.get('/editor', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'translation-editor.html'));
});
